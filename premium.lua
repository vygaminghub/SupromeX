...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Suprome X Premium") then
			makefolder("Suprome X Premium")
		end
		if not isfolder("Suprome X Premium/Blox Fruits/") then
			makefolder("Suprome X Premium/Blox Fruits/")
		end
		if not isfile("Suprome X Premium/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Suprome X Premium/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Suprome X Premium/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Suprome X Premium/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Suprome X Premium/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
	...
	game:GetService("RunService").Stepped:Connect(function()
		pcall(function()
			...
			if _G.Settings.Main["Auto Farm Level"] or _G.Settings.Main["Auto New World"] or
				...
				_G.Settings.Main["Auto Farm Boss Hallow"] or _G.Settings.Main["Mob Aura"] or _G.Settings.Main["Auto Material Soul Guitar"] or _G.Settings.Main["Auto Quest Soul Guitar"] or YamaQuest2 or YamaQuest1 or Auto_Cursed_Dual_Katana or
...
function CheckQuest()
	...
	if SecondSea then
		...
		elseif MyLevel == 775 or MyLevel <= 849 then -- Swan Pirate [Lv. 775]
			LevelFarm = 3
		...
		elseif MyLevel == 850 or MyLevel <= 874 then -- Factory Staff [Lv. 800]
			LevelFarm = 4
...
function GetBossName()
	for i,v in pairs(game.ReplicatedStorage:GetChildren()) do
		if not _G.GetBoss then
			...
			elseif v.Name == "Warden [Lv. 220] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 175 then
			...
			elseif v.Name == "Chief Warden [Lv. 230] [Boss]"  and game.Players.localPlayer.Data.Level.Value >= 200 then
				_G.Settings.Boss["Select Boss"] = "Chief Warden [Lv. 230] [Boss]"
			elseif v.Name == "Swan [Lv. 240] [Boss]"  and game.Players.localPlayer.Data.Level.Value >= 250 then
...
local Main = MainTab:CreateSection({
    Name = "General",
    Side = "Left"
})

local Time_Show = Main:AddLabel({
    Name = ''
})
...
function AutoFarmLevel()
	...
	if _G.Settings.Main["Skip Level"] and (MyLevel >= 15 and MyLevel <= 300) then
		...
		if MyLevel >= 15 and MyLevel <= 70 then
			...
			if game:GetService("Workspace").Enemies:FindFirstChild("God's Guard [Lv. 450]") then
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if _G.Settings.Main["Skip Level"] and v.Name == "God's Guard [Lv. 450]" and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
						repeat wait()
							...
							if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 300 then
								...
								for i2,v2 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
									if _G.Settings.Main["Skip Level"] and v2.Name == "God's Guard [Lv. 450]" and v2:FindFirstChild("HumanoidRootPart") and v2:FindFirstChild("Humanoid") and v2.Humanoid.Health > 0 then
						...
						until not (game:GetService("Workspace").Enemies:FindFirstChild("God's Guard [Lv. 450]")) or not (_G.Settings.Main["Skip Level"] or _G.Settings.Main["Auto Farm Level"]) or v.Humanoid.Health <= 0 or not v.Parent
						FastAttack = false
					end
				end
			else
				Modstween = toTarget(CFrameMon)
				if FirstSea and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude >1500 then
				...
				if table.find(AllPlayersTableSkipFarm,GetQuestTitle.Text:split(" ")[2]) then
					for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
						if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,v.Name) then
							if _G.Settings.Main["Auto Farm Level"] and _G.Settings.Main["Skip Level"] and v.Name == GetQuestTitle.Text:split(" ")[2] and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
								repeat wait(.2)
				...
				for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
					if _G.Settings.Main["Auto Farm Level"] and v.Name == Name and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
						if string.find(GetQuestTitle.Text, NameMon) then
							repeat wait()
								FarmtoTarget = toTarget(v.HumanoidRootPart.CFrame * CFrame.new(0,_G.Settings.Setting["Distance Auto Farm"],0))
								if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 250 then
									...
									if game.Players.LocalPlayer.Data.Level.Value >= 20 and game.Players.LocalPlayer.Data.Level.Value <= 90 then
										_G.Settings.Setting["Fast Attack Type"] = "Slow"
									else
										_G.Settings.Setting["Fast Attack Type"] = "Fast"
									end
									...
									game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0,_G.Settings.Setting["Distance Auto Farm"],0)
								end
...
-- Check Notification & Double Quest
...
Main:AddToggle({
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Mob Aura",
			})
		else
			library.Notify({
				Text = "Enable Mob Aura",
				Duration = 5
			})
			wait()
			toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
	...
	while wait() do
		pcall(function()
			if _G.Settings.Main["Mob Aura"] then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if _G.Settings.Main["Mob Aura"] and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= _G.Settings.Setting["Distance Mob Aura"] then
						repeat wait()
							StartMagnet = true
							FastAttack = true
							if _G.Settings.Setting["Auto Haki"] then
							...
							v.HumanoidRootPart.CanCollide = false
							v.Humanoid:ChangeState(11)
							toTarget(v.HumanoidRootPart.CFrame * CFrame.new(0,_G.Settings.Setting["Distance Auto Farm"],0))
							MagnetMobAura = true
							if delay then
								delay(1,function()
									MagnetMobAura = true
...
Main:AddToggle({
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Tp Chest",
			})
		else
			library.Notify({
				Text = "Enable Tp Chest",
				Duration = 5
			})
		end
		SaveSettings()
...
if FirstSea then
	Main:AddToggle{
		...
		Callback = function(Value)
			...
			if Value == false then
				library.Notify({
					Text = "Enable Auto New World",
				})
			else
				library.Notify({
					Text = "Disable Auto New World",
					Duration = 5
				})
				wait()
				toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
if SecondSea then
	...
	Main:AddToggle{
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Enable Auto Ectoplasm",
				})
			else
				library.Notify({
					Text = "Disable Auto Ectoplasm",
					Duration = 5
				})
				wait()
				toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
	...
	Main:AddToggle{
		...
		callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Enable Auto Third Sea",
				})
			else
				library.Notify({
					Text = "Disable Auto Third Sea",
					Duration = 5
				})
				wait()
				toTarget(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
...
Main:AddToggle({
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Auto Farm Fruit Mastery",
			})
		else
			library.Notify({
				Text = "Enable Auto Farm Fruit Mastery",
				Duration = 5
			})
		end
	end
...
Main:AddToggle({
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Bring Mob",
			})
		else
			library.Notify({
				Text = "Enable Bring Mob",
				Duration = 5
			})
		end
	end
...
Main:AddToggle({
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Fast Attack",
			})
		else
			library.Notify({
				Text = "Enable Fast Attack",
				Duration = 5
			})
		end
	end
...
Main:AddDropdown({
    ...
    Flag = "Fast_Attack_Mode",
    Value = _G.Settings.Setting["Fast Attack Mode"],
    List = {"Normal Fast","Premium Fast","Super Fast"},
    Callback = function(Value)
    ...
    while task.wait(.1) do
        ...
        if ac and ac.equipped then
            if FastAttack and _G.Settings.Setting["Fast Attack"] then
                AttackFunction()
                if _G.Settings.Setting["Fast Attack Mode"] == "Normal Fast" then
                    if tick() - cooldownfastattack > .7 then wait(.1) cooldownfastattack = tick() end
                elseif _G.Settings.Setting["Fast Attack Mode"] == "Premium Fast" then
                ...
                elseif _G.Settings.Setting["Fast Attack Mode"] == "Super Fast" then
                    if tick() - cooldownfastattack > 1 then wait(.01) cooldownfastattack = tick() end
                end
...
if _G.Settings.Setting["Distance Mob Aura"] == nil then
	_G.Settings.Setting["Distance Mob Aura"] = 1000
end

Main:AddSlider({
	Name = "Distance Mob Aura",
	Flag = "Distance_Mob_Aura",
	Value = _G.Settings.Setting["Distance Mob Aura"],
	Min = 1,
	Max = 5000,
	Callback = function(value)
		_G.Settings.Setting["Distance Mob Aura"] = value
		SaveSettings()
	end
})

local Stat = MainTab:CreateSection({
	Name = "Stat",
	Side = "Left"
})
...
Stat:AddToggle{
    ...
    Value = _G.Settings.Stats["Auto Stats Kaitun"],
    Callback  = function(Value)
        _G.Settings.Stats["Auto Stats Kaitun"] = Value
		SaveSettings()
		if value == false then
			library.Notify({
				Text = "Disable Auto Stats Kaitun",
			})
		else
			library.Notify({
				Text = "Enable Auto Stats Kaitun",
				Duration = 5
			})
		end
    end
			...
			if _G.Settings.Stats["Auto Stats Kaitun"] then
				if FirstSea then
					local args = {
						[1] = "AddPoint",
						[2] = "Melee",
						[3] = _G.Settings.Stats["Point Select"]
						}
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
				elseif SecondSea then
					local args = {
...
Stat:AddToggle{
    ...
    Value = _G.Settings.Stats["Auto Stats Melee"],
    Callback  = function(Value)
		_G.Settings.Stats["Auto Stats Melee"] = Value
		SaveSettings()
		if value == false then
			library.Notify({
				Text = "Disable Auto Stats Melee",
			})
		else
			library.Notify({
				Text = "Enable Auto Stats Melee",
				Duration = 5
			})
		end
    end
...
Stat:AddToggle{
    ...
    Value = _G.Settings.Stats["Auto Stats Defense"],
    Callback  = function(Value)
		_G.Settings.Stats["Auto Stats Defense"] = Value
		SaveSettings()
		if value == false then
			library.Notify({
				Text = "Disable Auto Stats Defense",
			})
		else
			library.Notify({
				Text = "Enable Auto Stats Defense",
				Duration = 5
			})
		end
    end
...
Stat:AddToggle{
    ...
    Value = _G.Settings.Stats["Auto Stats Sword"],
    Callback  = function(Value)
		_G.Settings.Stats["Auto Stats Sword"] = Value
		SaveSettings()
		if value == false then
			library.Notify({
				Text = "Disable Auto Stats Sword",
			})
		else
			library.Notify({
				Text = "Enable Auto Stats Sword",
				Duration = 5
			})
		end
    end
...
Stat:AddToggle{
    Name = "Gun",
    Flag = "Auto_Stats_Gun",
    Value = _G.Settings.Stats["Auto Stats Gun"],
    Callback  = function(Value)
		_G.Settings.Stats["Auto Stats Gun"] = Value
		SaveSettings()
		if value == false then
			library.Notify({
				Text = "Disable Auto Stats Gun",
			})
		else
			library.Notify({
				Text = "Enable Auto Stats Gun",
				Duration = 5
			})
		end
    end
...
Stat:AddToggle{
    ...
    Value = _G.Settings.Stats["Auto Stats Devil Fruit"],
    Callback  = function(Value)
		_G.Settings.Stats["Auto Stats Devil Fruit"] = Value
		SaveSettings()
		if value == false then
			library.Notify({
				Text = "Disable Auto Stats Devil Fruit",
			})
		else
			library.Notify({
				Text = "Enable Auto Stats Devil Fruit",
				Duration = 5
			})
		end
    end
...
Stat:AddSlider({
    Name = "Select Point",
    Flag = "Select_Point",
    Value = _G.Settings.Stats["Point Select"],
    Min = 1,
    Max = 100,
    Textbox = true,
    Format = function(Value)
		_G.Settings.Stats["Point Select"] = Value
		SaveSettings()
    ...
    while wait(.1) do
        if _G.Settings.Stats["Auto Stats Melee"] then
            if game:GetService("Players").LocalPlayer.Data.Points.Value > 0 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Melee", _G.Settings.Stats["Point Select"])
            end
        end
    end
end)
...
spawn(function()
    while wait(.1) do
        if _G.Settings.Stats["Auto Stats Defense"] then
            if game:GetService("Players").LocalPlayer.Data.Points.Value > 0 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Defense", _G.Settings.Stats["Point Select"])
            end
        end
    end
end)
...
spawn(function()
    while wait(.1) do
        if _G.Settings.Stats["Auto Stats Sword"] then
            if game:GetService("Players").LocalPlayer.Data.Points.Value > 0 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Sword", _G.Settings.Stats["Point Select"])
            end
        end
    end
end)
...
spawn(function()
    while wait(.1) do
        if _G.Settings.Stats["Auto Stats Gun"] then
            if game:GetService("Players").LocalPlayer.Data.Points.Value > 0 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Gun", _G.Settings.Stats["Point Select"])
            end
        end
    end
end)
...
spawn(function()
    while wait(.1) do
        if _G.Settings.Stats["Auto Stats Devil Fruit"] then
            if game:GetService("Players").LocalPlayer.Data.Points.Value > 0 then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AddPoint", "Demon Fruit", _G.Settings.Stats["Point Select"])
            end
        end
    end
end)

local Boss = MainTab:CreateSection({
    Name = "Boss",
    Side = "Left"
})
...
Boss:AddToggle{
    ...
    Callback  = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable Auto Farm Boss",
			})
		else
			library.Notify({
				Text = "Enable Auto Farm Boss",
				Duration = 5
			})
		end
    end
...
Boss:AddToggle{
    ...
    Callback  = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable Auto Farm All Boss",
			})
		else
			library.Notify({
				Text = "Enable Auto Farm All Boss",
				Duration = 5
			})
		end
    end
...
Boss:AddToggle{
    ...
    Value = _G.Settings.Boss["Auto Quest Boss"],
    Callback  = function(Value)
		_G.Settings.Boss["Auto Quest Boss"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Auto Quest Boss",
			})
		else
			library.Notify({
				Text = "Enable Auto Quest Boss",
				Duration = 5
			})
		end
    end
...
local Setting = MainTab:CreateSection({
    Name = "Main Setting",
    Side = "Right"
})
...
Setting:AddDropdown{
    Name = "Select Weapon",
    Flag = "Select_Weapon",
    Value = _G.Settings.Setting["Select Weapon"],
...
Setting:AddToggle{
    ...
    Callback = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable Auto Auto Haki",
			})
		else
			library.Notify({
				Text = "Enable Auto Auto Haki",
				Duration = 5
			})
		end
    end
...
Setting:AddToggle{
    Name = "Camera Shaker",
    Flag = "Camera_Shaker",
    Value = _G.Settings.Setting["Camera Shaker"],
    Callback = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable Camera Shaker",
			})
		else
			library.Notify({
				Text = "Enable Camera Shaker",
				Duration = 5
			})
		end
    end
...
Setting:AddToggle{
    ...
    Callback = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable Bypass TP",
			})
		else
			library.Notify({
				Text = "Enable Bypass TP",
				Duration = 5
			})
		end
    end
...
Setting:AddToggle{
    Name = "Double Quest",
    Flag = "Double_Quest",
    Value = _G.Settings.Setting["Double Quest"],
    Callback = function(Value)
		_G.Settings.Setting["Double Quest"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Double Quest",
			})
		else
			library.Notify({
				Text = "Enable Double Quest",
				Duration = 5
			})
		end
    end
...
if FirstSea then
	Setting:AddToggle({
		Name = "Skip Level",
		Flag = "Skip_Level",
		Value = _G.Settings.Main["Skip Level"],
		Callback = function(Value)
			_G.Settings.Main["Skip Level"] = Value
			SaveSettings()
			if value == false then
				library.Notify({
					Text = "Disable Skip Level",
				})
			else
				library.Notify({
					Text = "Enable Skip Level",
					Duration = 5
				})
			end
		end
	...
	Setting:AddToggle{
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Buy Ablility",
				})
			else
				library.Notify({
					Text = "Enable Auto Buy Ablility",
					Duration = 5
				})
			end
		end
...
Setting:AddToggle{
	...
	Callback = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable White Screen",
			})
		else
			library.Notify({
				Text = "Enable White Screen",
				Duration = 5
			})
		end
	end
...
Setting:AddToggle{
	...
	Flag = "Auto_Redeem_Code",
	Value = _G.Settings.Stats["Auto Redeem Code"],
	Callback = function(Value)
		_G.Settings.Stats["Auto Redeem Code"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Auto Redeem Code",
			})
		else
			library.Notify({
				Text = "Enable Auto Redeem Code",
				Duration = 5
			})
		end
	end
...
Setting:AddSlider({
    Name = "Level Redeem Code",
    Flag = "Level_Redeem_Code",
    Value = _G.Settings.Stats["Level Redeem Code"],
    Min = 1,
    Max = 2400,
    Textbox = true,
    Format = function(Value)
		_G.Settings.Stats["Level Redeem Code"] = Value
		SaveSettings()
        return "Level Redeem Code : " .. tostring(Value)
    end
})
...
task.spawn(function()
	while wait() do
		pcall(function()
			local MyLevel = game.Players.LocalPlayer.Data.Level.Value
			if _G.Settings.Stats["Auto Redeem Code"] then
				if MyLevel >= _G.Settings.Stat["Select Level Redeem Code"] then
					...
					wait(3)
					_G.Settings.Stats["Auto Redeem Code"] = false
				end
			end
		end)
	end
...
Setting:AddToggle{
	Name = "Skill Z",
	Flag = "Skill_Z",
	Value = _G.Settings.Setting["Skill Z"],
	Callback = function(Value)
		_G.Settings.Setting["Skill Z"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Skill Z",
			})
		else
			library.Notify({
				Text = "Enable Skill Z",
...
Setting:AddToggle{
	Name = "Skill X",
	Flag = "Skill_X",
	Value = _G.Settings.Setting["Skill X"],
	Callback = function(Value)
		_G.Settings.Setting["Skill X"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Skill X",
			})
		else
			library.Notify({
				Text = "Enable Skill X",
...
Setting:AddToggle{
	Name = "Skill C",
	Flag = "Skill_C",
	Value = _G.Settings.Setting["Skill C"],
	Callback = function(Value)
		_G.Settings.Setting["Skill C"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Skill C",
			})
		else
			library.Notify({
				Text = "Enable Skill C",
...
Setting:AddToggle{
	Name = "Skill V",
	Flag = "Skill_V",
	Value = _G.Settings.Setting["Skill V"],
	Callback = function(Value)
		_G.Settings.Setting["Skill V"] = Value
		SaveSettings()
		if Value == false then
			library.Notify({
				Text = "Disable Skill V",
			})
		else
			library.Notify({
				Text = "Enable Skill V",
...
Setting:AddSlider({
    Name = "Health For Mastery",
    Flag = "Health_For_Mastery",
    ...
    Format = function(Value)
		...
		SaveSettings()
        return "(%) Health For Mastery : " .. tostring(Value)
    end
})
...
Setting:AddButton({
    ...
    Callback = function()
		game.StarterGui:SetCore("SendNotification", {
			Title = "Hop Server", 
			Text = "Successfully!",
			Icon = "http://www.roblox.com/asset/?id=11761723081",
			Duration = 10
		})
		ServerHop:Teleport()
    end
...
local Item = ItemTab:CreateSection({
	Name = "Melee",
	Side = "Left"
})
...
Item:AddToggle{
	...
	Callback = function(Value)
		...
		if Value == false then
			library.Notify({
				Text = "Disable Auto Superhuman",
			})
		else
			library.Notify({
				Text = "Enable Auto Superhuman",
				Duration = 5
			})
		end
	end
...
Item:AddToggle{
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Auto Death Step",
			})
		else
			library.Notify({
				Text = "Enable Auto Death Step",
				Duration = 5
			})
		end
	end
...
task.spawn(function()
	while wait() do
		pcall(function()
			...
			elseif _G.Settings.FightingStyle["Auto Death Step"] then
...
Item:AddToggle{
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Auto Electric Claw",
			})
		else
			library.Notify({
				Text = "Enable Auto Electric Claw",
				Duration = 5
			})
		end
	end
...
Item:AddToggle{
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Auto SharkMan Karate",
			})
		else
			library.Notify({
				Text = "Enable Auto SharkMan Karate",
				Duration = 5
			})
		end
	end
...
task.spawn(function()
	while wait() do
		pcall(function()
			...
			elseif _G.Settings.FightingStyle["Auto SharkMan Karate"] then
...
Item:AddToggle{
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Auto Dragon Talon",
			})
		else
			library.Notify({
				Text = "Enable Auto Dragon Talon",
				Duration = 5
			})
		end
	end
...
Item:AddToggle{
	...
	Callback = function(value)
		...
		if value == false then
			library.Notify({
				Text = "Disable Auto God Human",
			})
		else
			library.Notify({
				Text = "Enable Auto God Human",
				Duration = 5
			})
		end
	end
...
if FirstSea then
	...
	Item:AddToggle{
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Saber",
				})
			else
				library.Notify({
					Text = "Enable Auto Saber",
					Duration = 5
				})
			end
		end
	...
	Item:AddToggle{
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Pole",
				})
			else
				library.Notify({
					Text = "Enable Auto Pole",
					Duration = 5
				})
			end
		end
...
if SecondSea then
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Factory",
				})
			else
				library.Notify({
					Text = "Enable Auto Factory",
					Duration = 5
				})
			end
		end
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Bartilo Quest",
				})
			else
				library.Notify({
					Text = "Enable Auto Bartilo Quest",
					Duration = 5
				})
			end
		end
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto True Triple Katana",
				})
			else
				library.Notify({
					Text = "Enable Auto True Triple Katana",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Rengoku",
				})
			else
				library.Notify({
					Text = "Enable Auto Rengoku",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Swan Glasses",
				})
			else
				library.Notify({
					Text = "Enable Auto Swan Glasses",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Dark Coat",
				})
			else
				library.Notify({
					Text = "Enable Auto Dark Coat",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Buy Legendary Sword",
				})
			else
				library.Notify({
					Text = "Enable Auto Buy Legendary Sword",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		FLag = "Auto_Buy_Enchanment_Haki",
		Value = _G.Settings.Main["Auto Buy Enchanment Haki"],
		callback = function(value)
			_G.Settings.Main["Auto Buy Enchanment Haki"] = value
			if value == false then
				library.Notify({
					Text = "Disable Auto Buy Enchanment Haki",
				})
			else
				library.Notify({
					Text = "Enable Auto Buy Enchanment Haki",
					Duration = 5
				})
			end
			SaveSettings()
...
if ThirdSea then
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Holy Torch",
				})
			else
				library.Notify({
					Text = "Enable Auto Holy Torch",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Buddy Swords",
				})
			else
				library.Notify({
					Text = "Enable Auto Buddy Swords",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Farm Boss Hallow",
				})
			else
				library.Notify({
					Text = "Enable Auto Farm Boss Hallow",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Rainbow Haki",
				})
			else
				library.Notify({
					Text = "Enable Auto Rainbow Haki",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Elite Hunter",
				})
			else
				library.Notify({
					Text = "Enable Auto Elite Hunter",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Musketeer Hat",
				})
			else
				library.Notify({
					Text = "Enable Auto Musketeer Hat",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Ken-Haki V2",
				})
			else
				library.Notify({
					Text = "Enable Auto Ken-Haki V2",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Cavander",
				})
			else
				library.Notify({
					Text = "Enable Auto Cavander",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Tushita Sword",
				})
			else
				library.Notify({
					Text = "Enable Auto Tushita Sword",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Serpent Bow",
				})
			else
				library.Notify({
					Text = "Enable Auto Serpent Bow",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Dark Dagger",
				})
			else
				library.Notify({
					Text = "Enable Auto Dark Dagger",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Flag = "Auto_Random_Bone",
		Value = _G.Settings.Main["Auto Random Bone"],
		Callback = function(value)
			_G.Settings.Main["Auto Random Bone"] = value
			if value == false then
				library.Notify({
					Text = "Disable Auto Random Bone",
				})
			else
				library.Notify({
					Text = "Enable Auto Random Bone",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Cake Prince",
				})
			else
				library.Notify({
					Text = "Enable Auto Cake Prince",
					Duration = 5
				})
			end
			SaveSettings()
	...
	Item:AddToggle({
		...
		Callback = function(value)
			...
			if value == false then
				library.Notify({
					Text = "Disable Auto Dough V2",
				})
			else
				library.Notify({
					Text = "Enable Auto Dough V2",
					Duration = 5
				})
			end
			SaveSettings()
...
local TeleportWorld = TeleportTab:CreateSection({
	Name = "Teleport World",
	Side = "Left"
})
...
local TeleportIsland = TeleportTab:CreateSection({
...
local Materials = TeleportTab:CreateSection({
...
local Raid = RaidTab:CreateSection({
	Name = "Raid",
	Side = "Left"
})
...
Raid:AddDropdown({
    ...
    Flag = "Select Raids",
    List = Dungeon,
	Value = _G.Settings.Raids["Select Raids"],
    Callback = function(value)
...
if _G.Settings.Fruits["Select Devil Fruits"] == nil then
    _G.Settings.Fruits["Select Devil Fruits"] = ""
end

Shop:AddDropdown({
	Name = "Select Devil Fruits",
	Flag = "Select_Devil_Fruits",
	Value = _G.Settings.Fruits["Select Devil Fruits"],
...
Shop:AddToggle({
	...
	Flag = "Auto_Buy_Devil_Fruits",
	Value = _G.Settings.Fruits["Auto Buy Devil Fruits"],
	Callback = function(value)
		_G.Settings.Fruits["Auto Buy Devil Fruits"] = value
		SaveSettings()
	end
})
...
spawn(function()
	while wait() do
		if _G.Settings.Fruits["Auto Buy Devil Fruits"] then
			pcall(function()
				local string_1 = "PurchaseRawFruit";
				local string_2 = _G.Settings.Fruits["Select Devil Fruits"];
				local Target = game:GetService("ReplicatedStorage").Remotes["CommF_"];
				Target:InvokeServer(string_1, string_2);
			end)
		end                              
...
Shop:AddToggle({
	...
	Flag = "Auto_Bring_Fruits",
	Value = _G.Settings.Fruits["Auto Bring Fruits"],
	Callback = function(value)
		_G.Settings.Fruits["Auto Bring Fruits"] = value
		SaveSettings()
	end
})
...
spawn(function()
    while wait(.2) do
        pcall(function()
            if _G.Settings.Fruits["Auto Bring Fruits"] then
...
Shop:AddToggle({
	...
	Value = _G.Settings.Fruits["Auto Store Fruit"],
	Callback = function(value)
		_G.Settings.Fruits["Auto Store Fruit"] = value
		SaveSettings()
	end
})
...
spawn(function()
    while wait() do
        if _G.Settings.Fruits["Auto Store Fruit"] then wait()
            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
local AbilityShop = ShopTab:CreateSection({
	Name = "Ability Shop",
	Side = "Right"
})

AbilityShop:AddButton({
	Name = "Geppo",
	Callback = function()
...
local FightingStyleShop = ShopTab:CreateSection({
...
local AccessoryShop = ShopTab:CreateSection({
	Name = "Accessory Shop",
	Side = "Right"
})

AccessoryShop:AddButton({
	Name = "Buy Tomoe Ring",
	Callback = function()
...
local SwordShop = ShopTab:CreateSection({
	Name = "Sword Shop",
	Side = "Left"
})
...
local GunShop = ShopTab:CreateSection({
	Name = "Gun Shop",
	Side = "Right"
})
...
local Racefragment = ShopTab:CreateSection({
	Name = "Race&Fragment Shop",
	Side = "Right"
})

Racefragment:AddButton({
	Name = "Buy Race Ghoul",
	Callback = function()
		local args = {
			[1] = "Ectoplasm",
...
local Join = MiscTab:CreateSection({
    Name = "Join",
	Side = "Right"
})
...
local OpenMenu = MiscTab:CreateSection({
    Name = "Open Menu",
	Side = "Left"
})
